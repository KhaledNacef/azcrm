...
import CreateDeliveryNoteModala from './cratefv.jsx';
          ...
          {!loading && filteredNotes.length > 0 ? (
            filteredNotes.map((note) => (
              <TableRow key={note.id}>
                ...
                <TableCell>{note.totalcosts || 'N/A'}</TableCell>
                <TableCell>{note.totalprofit }</TableCell>
                ...
                <TableCell sx={{ display: 'flex', gap: 1 }}>
                  <Button
                    variant="outlined"
                    onClick={() => navigate(`/fichev/${note.id}`)}
                  >
                    Voir
                  </Button>
