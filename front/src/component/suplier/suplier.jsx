...
const FournisseurPage = () => {
  ...
  const fetchFournisseurs = async () => {
    try {
      const response = await axios.get('https://api.azcrm.deviceshopleader/api/suplier/getsuppliers');
  ...
  const handleAddFournisseur = async () => {
    try {
      const response = await axios.post('https://api.azcrm.deviceshopleader/api/suplier/suppliers', formData);
  ...
  const handleUpdateFournisseur = async () => {
    try {
      await axios.put(`https://api.azcrm.deviceshopleader/api/suplier/upsuppliers/${editData.id}`, editData);
  ...
  const handleDeleteFournisseur = async (id) => {
    try {
      await axios.delete(`https://api.azcrm.deviceshopleader/api/suplier/delsuppliers/${id}`);
