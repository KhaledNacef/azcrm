...
const App = () => {
  ...
  <Route element={<RequireAuth />}>
    <Route path="/" element={<Layout />}>
      ...
      <Route path="bon-livraison/:code/:clientId/:codey/:devise/:num" element={<SingleDeliverysortie />} />
      <Route path="bon-commandefacture" element={<Boncommandev />} />
      <Route path="bon-commandefacturee/:code/:clientId/:codey/:devise/:num" element={<Bvsinlge />} />
